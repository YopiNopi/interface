...
const initialQuests: Quest[] = [
  { id: 1, title: "First Bet", description: "Win your first bet", points: 100, completed: false, icon: <Trophy className="w-5 h-5 text-yellow-500" />, category: 'in-game' },
  ...
  { id: 5, title: "Unbeatable", description: "Win 5 bet in a row", points: 1000, completed: false, icon: <Trophy className="w-5 h-5 text-purple-500" />, category: 'achievement' },
  { id: 6, title: "Veteran", description: "50 Bets", points: 300, completed: false, icon: <Award className="w-5 h-5 text-indigo-500" />, category: 'achievement' },
]
          ...
          <div className="flex justify-center space-x-2">
            {(['all', 'in-game', 'social', 'achievement'] as const).map((category) => (
              <button
                ...
                className={`p-2 rounded-full transition-all duration-300 ${activeCategory === category
